...
int main() {
  ...
  do {
    system("cls");
    rules();
    wcout << L"Số tiền hiện tại có trong tài khoản của bạn là: " << amount << L" VND" << endl;
    ...
    wcout << L"\n" << playerName << L", Số tiền hiện tại của bạn là : " << amount << L" VND\n";
  ...
  wcout << L"\n";
  drawLine(80,'=');
  wcout << L"\nCảm ơn bạn đã tham gia thử thách game của chúng tôi.\nSố dư tài khoản của bạn là: " << amount << " VND\n\n";
  drawLine(80,'=');
